...
[![Platform](https://img.shields.io/badge/Platform-iOS%20%7C%20macOS%20%7C%20tvOS%20%7C%20watchOS-lightgrey.svg)](https://github.com/yourusername/swift-remove-markdown)
...
```swift
dependencies: [
    .package(url: "https://github.com/yourusername/swift-remove-markdown.git", from: "1.0.0")
]
```
